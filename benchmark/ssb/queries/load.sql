...
-- parquet
COPY customer FROM 'benchmark/ssb/data/sf1//customer.parquet' (FORMAT 'parquet');
...
-- COPY part FROM 'benchmark/ssb/data/sf1//part.csv.gz';
-- COPY supplier FROM 'benchmark/ssb/data/sf1//supplier.csv.gz';
-- .timer on
-- COPY lineorder FROM 'benchmark/ssb/data/sf1//lineorder.csv.gz';
